...
(function () {
  ...
  /* Wide cartoon strip SVGs (not emoji) — each fills the name box */
  ...
  var BANNERS = [
    {
      ...
      src: strip(
        ["#fde68a", "#f59e0b"],
        "#fbbf24",
        '<rect x="8" y="8" width="12" height="48" rx="2" fill="#fcd34d"/><polygon points="14,4 20,10 8,10" fill="#ef4444"/><rect x="8" y="52" width="12" height="8" fill="#1e293b"/>'
      )
    },
    {
      id: "glue",
      ...
      src: strip(
        ["#bbf7d0", "#22c55e"],
        "#86efac",
        '<rect x="10" y="18" width="22" height="36" rx="4" fill="#4ade80"/><rect x="14" y="8" width="14" height="12" rx="2" fill="#fff"/><rect x="16" y="4" width="10" height="6" fill="#ef4444"/>'
      )
    },
    {
      id: "trumpet",
      ...
      src: strip(
        ["#fde047", "#eab308"],
        "#facc15",
        '<ellipse cx="12" cy="28" rx="10" ry="14" fill="#fbbf24"/><rect x="12" y="22" width="36" height="12" rx="3" fill="#f59e0b"/><circle cx="52" cy="28" r="8" fill="#fde047"/>'
      )
    },
    {
      id: "piano",
      ...
      src: strip(
        ["#e2e8f0", "#64748b"],
        "#f8fafc",
        '<rect x="4" y="16" width="48" height="32" rx="3" fill="#1e293b"/><rect x="8" y="20" width="6" height="20" fill="#fff"/><rect x="16" y="20" width="6" height="20" fill="#fff"/><rect x="24" y="20" width="6" height="20" fill="#fff"/><rect x="32" y="20" width="6" height="20" fill="#fff"/><rect x="40" y="20" width="6" height="20" fill="#fff"/><rect x="12" y="20" width="5" height="12" fill="#0f172a"/><rect x="20" y="20" width="5" height="12" fill="#0f172a"/><rect x="28" y="20" width="5" height="12" fill="#0f172a"/><rect x="36" y="20" width="5" height="12" fill="#0f172a"/>'
      )
    },
    {
      id: "hamburger",
      ...
      src: strip(
        ["#fdba74", "#ea580c"],
        "#fb923c",
        '<ellipse cx="28" cy="22" rx="22" ry="10" fill="#f59e0b"/><rect x="6" y="28" width="44" height="8" rx="2" fill="#22c55e"/><rect x="6" y="36" width="44" height="8" rx="2" fill="#78350f"/><ellipse cx="28" cy="50" rx="22" ry="10" fill="#d97706"/>'
      )
    },
    {
      id: "hotdog",
      ...
      src: strip(
        ["#fecdd3", "#f43f5e"],
        "#fb7185",
        '<ellipse cx="28" cy="36" rx="26" ry="12" fill="#fbbf24"/><ellipse cx="28" cy="36" rx="20" ry="8" fill="#ef4444"/>'
      )
    },
    {
      id: "burrito",
      ...
      src: strip(
        ["#fde68a", "#ca8a04"],
        "#facc15",
        '<ellipse cx="28" cy="36" rx="24" ry="18" fill="#eab308"/><path d="M12 28 Q28 18 44 28" fill="none" stroke="#78350f" stroke-width="3"/><path d="M14 36 Q28 28 42 36" fill="none" stroke="#78350f" stroke-width="2"/>'
      )
    },
    {
      id: "taco",
      ...
      src: strip(
        ["#fef08a", "#eab308"],
        "#fde047",
        '<path d="M8 48 Q28 8 48 48 Z" fill="#fbbf24"/><path d="M14 44 Q28 18 42 44" fill="#22c55e"/><circle cx="22" cy="36" r="3" fill="#ef4444"/><circle cx="34" cy="34" r="3" fill="#ef4444"/>'
      )
    },
    {
      id: "sushi",
      ...
      src: strip(
        ["#fecaca", "#f87171"],
        "#fca5a5",
        '<ellipse cx="20" cy="36" rx="14" ry="16" fill="#fff"/><ellipse cx="20" cy="36" rx="8" ry="10" fill="#ef4444"/><ellipse cx="42" cy="36" rx="14" ry="16" fill="#fff"/><ellipse cx="42" cy="36" rx="8" ry="10" fill="#f97316"/>'
      )
    },
    {
      id: "gordita",
      ...
      src: strip(
        ["#fed7aa", "#c2410c"],
        "#fdba74",
        '<ellipse cx="28" cy="36" rx="26" ry="20" fill="#f59e0b"/><ellipse cx="28" cy="36" rx="18" ry="12" fill="#fef3c7"/><circle cx="20" cy="34" r="3" fill="#22c55e"/><circle cx="32" cy="38" r="3" fill="#ef4444"/>'
      )
    },
    {
      id: "steak",
      ...
      src: strip(
        ["#fca5a5", "#b91c1c"],
        "#f87171",
        '<ellipse cx="28" cy="36" rx="24" ry="18" fill="#dc2626"/><ellipse cx="22" cy="32" rx="8" ry="6" fill="#fecaca"/><path d="M14 40 Q28 48 42 36" fill="none" stroke="#7f1d1d" stroke-width="2"/>'
      )
    },
    {
      id: "sandwich",
      ...
      src: strip(
        ["#fde68a", "#d97706"],
        "#fbbf24",
        '<rect x="6" y="18" width="44" height="10" rx="3" fill="#f59e0b"/><rect x="8" y="28" width="40" height="8" fill="#22c55e"/><rect x="8" y="36" width="40" height="8" fill="#ef4444"/><rect x="6" y="44" width="44" height="10" rx="3" fill="#d97706"/>'
      )
    },
    {
      id: "fries",
      ...
      src: strip(
        ["#fef08a", "#eab308"],
        "#facc15",
        '<rect x="12" y="36" width="32" height="22" rx="3" fill="#ef4444"/><rect x="16" y="12" width="6" height="28" rx="2" fill="#fbbf24"/><rect x="25" y="8" width="6" height="32" rx="2" fill="#f59e0b"/><rect x="34" y="14" width="6" height="26" rx="2" fill="#fbbf24"/>'
      )
    },
    {
      id: "quesadilla",
      ...
      src: strip(
        ["#fde68a", "#ca8a04"],
        "#facc15",
        '<path d="M8 48 L28 12 L48 48 Z" fill="#fbbf24"/><path d="M14 44 L28 20 L42 44 Z" fill="#fef08a"/><circle cx="24" cy="36" r="2.5" fill="#f97316"/><circle cx="32" cy="38" r="2.5" fill="#22c55e"/>'
      )
    }
  ];
  ...
  function ensureCSS() {
    ...
    s.textContent = [
      ...
      "  transition: filter 0.12s, transform 0.12s, box-shadow 0.12s !important;",
      ...
      "}",
      ".blacket-name-box.has-banner {",
      "  border-color: rgba(255,255,255,0.35) !important;",
      "}",
      /* dark scrim so text stays readable over banner art */
      ...
      "  z-index: 0 !important;",
      "}",
      /* hide tiny side icon — whole box is the banner now */
      ".banner-behind, #statsBannerBehind {",
      ...
      "}",
      /* modal picker — show strip previews */
      ".banners-modal {",
      "  max-width: 440px; width: 94%;",
      "  background: linear-gradient(180deg, #3b1a7a 0%, #2a1060 100%);",
      "  border: 3px solid #c084fc; border-radius: 20px;",
      "  box-shadow: 0 0 0 4px #7c3aed, 0 12px 40px rgba(0,0,0,0.45);",
      "  padding: 16px 18px 18px;",
      "}",
      ".banners-title {",
      "  margin:0; font-size:28px; font-weight:900; font-style:italic;",
      "  background: linear-gradient(180deg, #fde68a, #f472b6 60%, #c084fc);",
      ...
      "  overflow: hidden; position: relative; height: 56px; padding: 0;",
      ...
      "}",
      ".banner-slot .eq-tag {",
      "  position: absolute; top: 4px; right: 4px; background: #fbbf24; color: #1a1a2e;",
  ...
  function updateBannerDisplay(username) {
    ...
    if (b) {
      ...
      box.style.backgroundImage = "url('" + b.src + "')";
